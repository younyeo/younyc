                        ...
                        <fieldset>
                            ...
                            <div class="member-box">
                                <div>
                                    ...
                                    <input type="email" name="youEmail" id="youEmail" class="input_write" maxlength="20" placeholder="smaple@naver.com" autocmplete="off" autofocus>
                                </div>
                                <div>
                                    <label for="youPass">비밀번호</label>
                                    <input type="password" name="youPass" id="youPass" class="input_write" maxlength="20" placeholder="비밀번호를 입력해주세요!" autocmplete="off" required>
                                </div>
                                <div>
                                    <label for="youPassC">비밀번호 확인</label>
                                    <input type="youPassC" name="youPassC" id="youPassC" class="input_write" maxlength="20" placeholder="비밀번호를 다시 한번 입력해주세요!" autocmplete="off" required>
                                </div>
                                <div>
                                    <label for="youName">이름</label>
                                    <input type="youName" name="youName" id="youName" class="input_write" maxlength="5" placeholder="성함을 입력해주세요!" autocmplete="off" required>
                                </div>
                                <div>
                                    <label for="youBirth">생년월일</label>
                                    <input type="youBirth" name="youBirth" id="youBirth" class="input_write" placeholder="YYYY-MM-DD" autocmplete="off" required>
                                </div>
                                <div>
                                    <label for="youPhone">휴대폰 번호</label>
                                    <input type="youPhone" name="youPhone" id="youPhone" class="input_write" placeholder="000-0000-0000" autocmplete="off" required>
                                </div>
                            </div>
                        </fieldset>

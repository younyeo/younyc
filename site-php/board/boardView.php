                                ...
                                <table>
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            $sql = "SELECT b.boardTitle, b.boardContent, b.boardView, m.youName, b.regTime FROM myBoard99 b JOIN myMember m ON(b.myMemberID = m.myMemberID) WHERE b.myBoardID = {$boardID}";
                                            $result = $connect -> query($sql);

                                            $view = "UPDATE myBoard99 SET boardView = boardView+1 WHERE myBoardID = {$boardID}";
                                            $connect -> query($view);

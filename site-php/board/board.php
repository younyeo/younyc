                ...
                <div class="boardType">
                    ...
                    <div class="board">
                            ...
                            <table>
                                ...
                                <tbody>
                                    <?php    
                                        ...
                                        //1~10 : DESC LIMIT 0, 20  --> $page =1 ($numView * $page) - $numView
                                        ...
                                        //borard + member
                                        $sql = "SELECT b.myBoardID, b.boardTitle, m.youName, b.boardView, b.regTime FROM myMember m JOIN myBoard99 b ON (m.myMemberID = b.myMemberID) ORDER BY myBoardID DESC LIMIT {$viewLimit}, {$numView}";
                        ...
                        <div class="board-page">
                            <ul>
                                <?php
                                    $sql = "SELECT count(myBoardID) FROM myBoard99";
                                    $result = $connect -> query($sql);
                                    
                                    $boardTotalCount = $result -> fetch_array(MYSQLI_ASSOC);
                                    $boardTotalCount = $boardTotalCount['count(myBoardID)'];
                                
                                    // echo "전채 갯수 :" .$boardTotalCount;

                            ...
                            <form action="boardModifySave.php" name="boradModify" method="post">
                                <fieldset>
                                    ...
                                    <?php
                                        ...
                                        $sql = "SELECT b.boardTitle, b.boardContent, b.boardView, m.youName FROM myBoard99 b JOIN myMember m ON (b.myMemberID = m.myMemberID) WHERE b.myBoardID = {$boardID}";
